...
export const contentColumnClass =
  "app-page mx-auto w-full max-w-md min-w-0 sm:max-w-lg";

/** Wraps any label + control so fields stay inside page gutters on mobile */
export const formFieldWrapperClass = "block w-full min-w-0 max-w-full";

/** Apply to <form> so all nested inputs/selects respect page width */
export const formClass = "app-form w-full min-w-0 max-w-full space-y-5 sm:space-y-6";
